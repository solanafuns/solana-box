...
RUN /root/.nvm/versions/node/v24.10.0/bin/npm install -g @anthropic-ai/claude-code
RUN /root/.nvm/versions/node/v24.10.0/bin/npm install -g @anthropic-ai/claude-code-router
